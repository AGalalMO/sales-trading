  ...
  return (
    <section className="bg-[#02110f] py-20 sm:py-24">
      <div className="content-wrap">
        <p className="text-xs uppercase tracking-[0.14em] text-emerald-300/85">INDUSTRIES
          WE SUPPORT</p>
        ...
        <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
          {industries.map((industry) => (
            <article
              key={industry.name}
              className="rounded-xl border border-emerald-200/15 flex flex-col h-full justify-between bg-[linear-gradient(145deg,rgba(8,44,40,0.28),rgba(1,24,22,0.84))] p-5"
            >
